...
router.post('/', checkAuth(...Object.values(UserRole)), validateRequest(createBookingZodSchema), BookingController.createBooking);
...
router.patch('/:bookingId/status', checkAuth(...Object.values(UserRole)), validateRequest(updateBookingZodSchema), BookingController.updateBookingStatus);
